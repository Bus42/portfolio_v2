  ...
  return (
    <div id="imageCard" className="card transparent white-text">
      ...
      <div className="card-content">
        <span className="card-title activator">{props.card.title}<i className="material-icons right">expand_more</i></span>
      </div>
      <div className="card-reveal grey darken-3">
        <span className="card-title">{props.card.title}<i className="material-icons right">close</i></span>
